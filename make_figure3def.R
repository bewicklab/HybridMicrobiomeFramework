...
B73Mo17leaf_bs<-FourHbootstrapA(B73Mo17leaf_physeq,B73Mo17leafno,0.5,500,10)
...
B73Mo17rhizosphere_bs<-FourHbootstrapA(B73Mo17rhizosphere_physeq,B73Mo17rhizosphereno,0.5,500,10)
...
B73Mo17leaffungi_bs<-FourHbootstrapA(B73Mo17leaffungi_physeq,B73Mo17leaffungino,0.5,500,10)
...
B73Mo17rhizospherefungi_bs<-FourHbootstrapA(B73Mo17rhizospherefungi_physeq,B73Mo17rhizospherefungino,0.5,500,10)
...
B73CML103leaf_bs<-FourHbootstrapA(B73CML103leaf_physeq,B73CML103leafno,0.5,500,10)
...
B73Mo18Wleaf_bs<-FourHbootstrapA(B73Mo18Wleaf_physeq,B73Mo18Wleafno,0.5,500,10)
...
B73CML103rhizosphere_bs<-FourHbootstrapA(B73CML103rhizosphere_physeq,B73CML103rhizosphereno,0.5,500,10)
...
B73Mo18Wrhizosphere_bs<-FourHbootstrapA(B73Mo18Wrhizosphere_physeq,B73Mo18Wrhizosphereno,0.5,500,10)
...
FourHquaternary(B73CML103leaf_bs,col='green',size_bootstrap=0.5, add=TRUE)
