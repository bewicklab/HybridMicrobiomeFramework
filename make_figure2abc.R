...
cicada_bs<-FourHbootstrap(cicada_physeq,cicadano,0.5,500,7)
...
lizard_bs<-FourHbootstrap(lizard_physeq,lizardno,0.5,500,7)
...
woodrat_bs<-FourHbootstrap(woodrat_physeq,woodratno,0.5,500,7)
